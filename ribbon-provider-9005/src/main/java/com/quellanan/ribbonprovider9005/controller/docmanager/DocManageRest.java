...
import com.quellanan.ribbonprovider9005.controller.docmanager.ConfigurationUtil;
...
public class DocManageRest {
	...
	public static void main(String[] args) {
		...
		String s=dmrt.downloadFile("39865","测试文件",null,"1");

		String fio=dmrt.parseJSONArray(s,"11");
